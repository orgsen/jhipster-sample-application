package mr.senhit.test.config.timezone;

import mr.senhit.test.JhipsterSampleApplicationApp;
import mr.senhit.test.repository.timezone.DateTimeWrapper;
import mr.senhit.test.repository.timezone.DateTimeWrapperRepository;
