package mr.senhit.test.repository;

import mr.senhit.test.JhipsterSampleApplicationApp;
import mr.senhit.test.config.Constants;
import mr.senhit.test.config.audit.AuditEventConverter;
import mr.senhit.test.domain.PersistentAuditEvent;
...
import static mr.senhit.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
